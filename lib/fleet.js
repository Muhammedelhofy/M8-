...
async function buildFleetContext(message, history) {
  ...
  const followup = !!dateRef && recentlyDiscussedFleet(history);
...
module.exports = {
  ...
  unpackEntry, unpackDriver, periodSortKey, periodYMD, dayMetrics, rankDrivers, attentionFlags, renderPacket, renderNotFound,
};
