...
async function getLastM8Write() {
  ...
  const res = await fetch(`${url}/rest/v1/m8_wallet_writes?action=eq.add_expense&wallet_txn_id=not.is.null&order=created_at.desc&limit=1`, {
...
module.exports = {
  getSummary, addExpense, getCategorySpend, inferCategory,
