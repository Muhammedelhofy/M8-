...
const BUILD_STATE = {
  updated: "2026-06-10",
  commitFamily: "L4 lane (Verified Tool Orchestration): STATUS.md + verified output contract + auto-route compute (Builds 1-3) + North-Star correction",
  live: [
  ...
  pending: [
    "L4 Build-4 — Tool Decision Layer (CURRENT): the orchestrator LLM picks WHICH tool (fleet/search/compute); deterministic tools stay responsible for WHAT IS TRUE (hybrid — no regex rip-out); lift the verified-output contract from the compute lane to ALL tools",
    "L4 Build-5 — L4 eval probes: tool-selected, verification-present, confidence-calibrated, narration-not-exceeding-evidence",
