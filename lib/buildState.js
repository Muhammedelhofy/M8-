...
const BUILD_STATE = {
  ...
  pending: [
    "Chained search->compute as a real tool: feed a searched LIVE value into the compute sandbox in one turn (sequential ownership — search owns the live variable, compute owns the arithmetic). This is the capability behind the compound 'find the current rate then project' question; the Build-6 gate deliberately left it for here",
