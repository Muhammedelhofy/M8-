...
const BUILD_STATE = {
  updated: "2026-06-09",
  commitFamily: "L3: auto-firing brief (greeting) + driver-churn composite + red-team eval probes + streaming",
  live: [
  ...
  pending: [
    "Fleet Intelligence Layer (L3): rider risk scores (data-feasibility TBD — the blob is driver-centric, likely needs a different feed). Registry, tier-slip/coaching, on-demand + auto-firing morning brief, cash-collection, driver-churn composite, and streaming are all now shipped — rider risk is the main remaining L3 piece — current milestone",
