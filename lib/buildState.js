...
const BUILD_STATE = {
  updated: "2026-06-09",
  commitFamily: "Eval/scorecard harness + state-engine (L3.5 stateful-reasoning ceiling fix)",
  live: [
  ...
  pending: [
    "Streaming responses on /api/chat (SSE) + sentence-buffered TTS in the frontend — the L3 voice-UX unlock that masks the ~8-10s latency by speaking the first sentence while the rest still generates. Touches llm.js + orchestrator + chat.js + js/app.js + js/voice.js; scoped but not yet shipped",
