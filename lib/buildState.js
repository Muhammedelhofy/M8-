...
const BUILD_STATE = {
  updated: "2026-06-08",
  commitFamily: "L3: known-driver registry + fleet-gate fix + tier-slip watch/coaching",
  live: [
  ...
  pending: [
    "Fleet Intelligence Layer (L3 proactive): proactive morning/voice brief, cash-collection tracking, rider risk scores — current milestone (registry + on-demand tier-slip/coaching now shipped; remaining pieces are the proactive/auto-triggered ones)",
