...
const BUILD_STATE = {
  updated: "2026-06-08",
  commitFamily: "L3: known-driver registry + tier-slip watch + on-demand morning brief",
  live: [
    ...
    "Morning / exec brief (on-demand): 'give me the morning brief / state of the fleet' assembles one spoken exec summary from the spine — most-recent-complete-day net + trend, top performers, attention flags, tier slips, and week-to-date context; deterministic, LLM narrates only",
  ...
  pending: [
    "Fleet Intelligence Layer (L3): cash-collection tracking, rider risk scores, and the genuinely AUTO-firing/scheduled brief (the on-demand morning brief, tier-slip/coaching, and known-driver registry are now shipped; what's left is auto-triggering + the two new metrics) — current milestone",
