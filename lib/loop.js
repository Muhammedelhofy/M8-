 ...
 *     step 2  M3 test      -> runConjectureGenWithFeedback({seed: SEED_BASE+dayIndex}) — PURE-CODE gen, NO LLM; READS recorded outcomes to steer the packet (Build-112) AND the generated cohort (Build-113)
