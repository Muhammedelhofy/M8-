...
// free, non-thinking Llama, separate quota), then cerebras, then gemini-2.5-flash-LITE.
const CHAIN_MODEL   = process.env.M8_CHAIN_MODEL || "gemini-2.5-flash-lite";
const CHAIN_ORDER   = process.env.M8_CHAIN_ORDER || "groq,cerebras,gemini"; // free, non-thinking, separate quota
