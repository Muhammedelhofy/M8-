...
async function runConjectureGenWithFeedback(opts) {
  ...
  // Build-92: closed learning loop. Prepend the VERIFIED CONJECTURE PATTERNS block
  // so the proposer is told what already verified and to propose structurally
  // DIFFERENT conjectures. Additive + fail-safe: empty patterns / any error leaves
