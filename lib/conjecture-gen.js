...
async function runConjectureGenWithFeedback(opts) {
  ...
  // approaches). Prepend order is avoid-then-verified so the final packet reads
  // VERIFIED / AVOID / <packet>. Additive + fail-safe: empty patterns / any error leaves
  // the packet exactly as runConjectureGen built it.
  //
