...
async function orchestrate({ message, sessionId, history }) {
  ...
  try {
    ...
    if (intent === INTENT.NONE && !computeMode && !compoundMode && !discoveryMode && !isPersonal(effectiveMessage) && !conversational && !fleetCtx.text && !financeCtx.text && !eosbCtx.text && !companyCtx.text && !stateCtx.text && !notebookCtx.text && !openProblem && !buildQuery) {
      try {
    ...
    let topic = null;
    if (intent !== INTENT.NONE && !computeMode && !compoundMode && !discoveryMode && !fleetCtx.text && !fleetLike && !financeCtx.text && !financeLike && !eosbCtx.text && !companyCtx.text && !stateCtx.text && !notebookCtx.text) {
    ...
    if (compoundMode && !discoveryMode && !fleetCtx.text && !fleetLike && !financeCtx.text && !financeLike && !eosbCtx.text && !companyCtx.text && !stateCtx.text && !notebookCtx.text) {
      trace.searchExecuted = true;
      try {
        const _tSearch = Date.now();
    ...
    const useCompute = (computeMode || routerCompute || effectiveTutorMode || discoveryMode || compoundMode) && !fleetCtx.text && !notebookCtx.text && !financeCtx.text && !eosbCtx.text;
    ...
    const computeContract = (computeMode || routerCompute || discoveryMode) && !compoundMode && !fleetCtx.text && !notebookCtx.text && !financeCtx.text && !eosbCtx.text;
