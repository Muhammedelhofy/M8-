...
async function orchestrate({ message, sessionId, history }) {
  ...
  try {
    ...
    if (!discoveryMode && !oeisMode && !leanMode && !m1Mode && !m3Mode && !notebookCtx.text && !fleetCtx.text && !financeCtx.text && !eosbCtx.text && !companyCtx.text && !stateCtx.text && !lemmaDagMode && !loopCtx.text) {
      try {
