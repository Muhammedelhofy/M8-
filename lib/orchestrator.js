...
function noteRefContext(history) {
  ...
  if (/Saved as a note|حفظتها كملاحظة|You have \d+ note|عندك \d+ ملاحظة|Notes about|ملاحظات عن|Deleted the note|حذفت الملاحظة|Your last note|آخر ملاحظة/.test(c)) return "recent";
  return null;
}
