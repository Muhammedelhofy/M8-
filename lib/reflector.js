...
// 429/cooldown), then cerebras, then gemini-2.5-flash-LITE (valid + non-thinking)
// as the last fallback. Env-overridable.
const REFLECT_MODEL = process.env.M8_REFLECT_MODEL || "gemini-2.5-flash-lite";
const REFLECT_ORDER = process.env.M8_REFLECT_ORDER || "groq,cerebras,gemini";
