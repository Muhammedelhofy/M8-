...
const SPECULATIVE_TARGET_SIM_MIN = 0.82; // same bar as noveltySemanticPass
...
async function checkSpeculativeTarget(targetText, sessionId) {
  try {
    ...
    const hits = await graphMatch(targetText, { k: 4, minSimilarity: SPECULATIVE_TARGET_SIM_MIN });
