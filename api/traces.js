...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    let q = sb
      .from("request_traces")
      .select("session_id, intent, provider, recovered, search_fired, search_results, memory_rows, playbooks, latency_ms, memory_ms, fleet_ms, router_ms, search_ms, llm_ms, summary_ms, tool_decision, ok, error, created_at")
